...
<body class="fixed-sidebar full-height-layout gray-bg" style="overflow:hidden">
                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            <span><img alt="image" class="img-circle" src="../../../Public/hou/img/profile_small.jpg" /></span>
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                               <span class="block m-t-xs"><strong class="font-bold">Ajax-大本营</strong></span>
                    ...
                    <li>
                        <a href="#">
                            ...
                            <span class="nav-label">主页管理</span>
                            <span class="fa arrow"></span>
                        </a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="index_v1.html" data-index="0">博客首页</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="menu.html" data-index="0">菜单管理</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-edit"></i> <span class="nav-label">博文管理</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li><a class="J_menuItem" href="/admin/article/essay">博文列表</a>
                            </li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-messages">
                                <li class="m-t-xs">
                                    <div class="dropdown-messages-box">
                                        <a href="profile.html" class="pull-left">
                                            <img alt="image" class="img-circle" src="../../../Public/hou/img/a7.jpg">
                                        </a>
                                ...
                                <li>
                                    <div class="dropdown-messages-box">
                                        <a href="profile.html" class="pull-left">
                                            <img alt="image" class="img-circle" src="../../../Public/hou/img/a4.jpg">
                                        </a>
                                        <div class="media-body ">
                    ...
                    <div id="tab-2" class="tab-pane">
                        ...
                        <div>
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="../../../Public/hou/img/a1.jpg">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="../../../Public/hou/img/a2.jpg">
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="../../../Public/hou/img/a3.jpg">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="../../../Public/hou/img/a4.jpg">
                                    </div>
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="../../../Public/hou/img/a8.jpg">
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="../../../Public/hou/img/a7.jpg">
                                    </div>
                                    <div class="media-body">
    ...
    <script src="../../../Public/hou/js/plugins/metisMenu/jquery.metisMenu.js"></script>
    <script src="../../../Public/hou/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>
    <script src="../../../Public/hou/js/plugins/layer/layer.min.js"></script>
    <script src="../../../Public/hou/js/hplus.min.js?v=4.1.0"></script>
    <script type="text/javascript" src="../../../Public/hou/js/contabs.min.js"></script>
    <script src="../../../Public/hou/js/plugins/pace/pace.min.js"></script>
</body>
