...
<head>
    ...
    <!-- Morris -->
    <link href="../../../Public/hou/css/plugins/morris/morris-0.4.3.min.css" rel="stylesheet">

    <!-- Gritter -->
    <link href="../../../Public/hou/js/plugins/gritter/jquery.gritter.css" rel="stylesheet">
...
<body class="gray-bg">
                            ...
                            <div class="feed-activity-list">
                                ...
                                <div class="feed-element">
                                    <a href="profile.html" class="pull-left">
                                        <img alt="image" class="img-circle" src="../../../Public/hou/img/profile.jpg">
                                    </a>
                                ...
                                <div class="feed-element">
                                    <a href="profile.html" class="pull-left">
                                        <img alt="image" class="img-circle" src="../../../Public/hou/img/a2.jpg">
                                    </a>
                                    <div class="media-body ">
                                ...
                                <div class="feed-element">
                                    <a href="profile.html" class="pull-left">
                                        <img alt="image" class="img-circle" src="../../../Public/hou/img/a3.jpg">
                                    </a>
                                    <div class="media-body ">
                                ...
                                <div class="feed-element">
                                    <a href="profile.html" class="pull-left">
                                        <img alt="image" class="img-circle" src="../../../Public/hou/img/a5.jpg">
                                    </a>
                                    <div class="media-body ">
    ...
    <script src="../../../Public/hou/js/plugins/flot/jquery.flot.js"></script>
    <script src="../../../Public/hou/js/plugins/flot/jquery.flot.tooltip.min.js"></script>
    <script src="../../../Public/hou/js/plugins/flot/jquery.flot.spline.js"></script>
    <script src="../../../Public/hou/js/plugins/flot/jquery.flot.resize.js"></script>
    <script src="../../../Public/hou/js/plugins/flot/jquery.flot.pie.js"></script>
    ...
    <script src="../../../Public/hou/js/plugins/jquery-ui/jquery-ui.min.js"></script>
    <script src="../../../Public/hou/js/plugins/gritter/jquery.gritter.min.js"></script>
    <script src="../../../Public/hou/js/plugins/easypiechart/jquery.easypiechart.js"></script>
    <script src="../../../Public/hou/js/plugins/sparkline/jquery.sparkline.min.js"></script>
    <script src="../../../Public/hou/js/demo/sparkline-demo.min.js"></script>
    <script>
